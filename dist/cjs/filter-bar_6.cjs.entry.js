...
const FilterBar = class {
    constructor(hostRef) {
        ...
        this.filterEvent = index.createEvent(this, "filterEvent", 7);
        this.formValues = {
            person: "",
            year: "",
            keyword: "",
    ...
    render() {
        return (index.h(index.Host, null, index.h("div", { class: "filter-bar" }, index.h("form", { id: "form", class: "gardener-search-filter" }, index.h("div", { class: "border p-3" }, index.h("h4", { class: "mb-3" }, "Datensatz finden"), index.h("div", { class: "row align-items-end" }, index.h("div", { class: "field-person form-group col-12 col-md-4 col-lg-3" }, index.h("label", { class: "col-form-label" }, "Person/Autor"), index.h("div", null, index.h("input", { class: "form-control", type: "text", id: "person", value: this.formValues.person, onInput: (event) => this.handleFormInput(event) }))), index.h("div", { class: "field-year form-group col-12 col-md-4 col-lg-3" }, index.h("label", { class: "col-form-label" }, "Jahr"), index.h("div", null, index.h("input", { class: "form-control", type: "text", id: "year", value: this.formValues.year, onInput: (event) => this.handleFormInput(event) }))), index.h("div", { class: "field-keyword form-group col-12 col-md-4 col-lg-3" }, index.h("label", { class: "col-form-label" }, "Stichwort"), index.h("div", null, index.h("input", { class: "form-control", type: "text", id: "keyword", value: this.formValues.keyword, onInput: (event) => this.handleFormInput(event) }))), index.h("div", { class: "form-group submit col pt-3 pt-lg-0" }, index.h("button", { type: "submit", class: "btn btn-primary submit-all", onClick: e => this.submitSearch(e) }, "Suchen")))), index.h("div", { class: "row mt-3" }, index.h("div", { class: "col-12 col-lg-9" }, index.h("div", { class: "border p-3 " }, index.h("h4", { class: "mb-3" }, "Nach Anfangsbuchstaben filtern"), index.h("ul", { class: "glossary d-flex flex-wrap justify-content-start" }, this.glossar()))), index.h("div", { class: "gardener-search-reset col-12 col-lg-3 mt-3 mt-lg-0 pl-lg-0" }, index.h("div", { class: "border p-3 h100" }, index.h("button", { type: "button", class: "btn btn-outline-dark btn-sm submit-selection", onClick: e => this.resetSearch(e) }, "Zur\u00FCcksetzen"))))))));
    }
...
const Detail = class {
    ...
    render() {
        if (this.cleanRecord) {
            return (index.h(index.Host, { id: "id" + this.record.ID, class: "mt-5" }, index.h("button", { type: "button", class: "close btn-sm mt-3 mr-3", "aria-label": "Close", onClick: e => this.closeDetail(e) }, "Zur\u00FCck ", index.h("i", { class: "fa fa-times-circle fa-lg", "aria-hidden": "true" })), index.h("div", { class: "border p-3 mt-3" }, index.h("h2", { class: "mb-3 mb-md-4" }, this.record.Person), index.h("table", { class: "table border-bottom stacktable" }, Object.keys(this.cleanRecord).map(key => (index.h("tr", null, index.h("td", { class: "label" }, index.h("strong", null, key)), index.h("td", null, this.cleanRecord[key]))))))));
        }
    }
...
const Results = class {
    ...
    resultInfo() {
        return (index.h("div", { class: "py-3 py-md-4 small" }, "Zeige ", this.total > 0 ? this.firstItemShown() + 1 + "–" + this.lastItemShown() + " von " + this.total + " Ergebnissen" : this.firstItemShown() + " Ergebnisse"));
    }
    render() {
        return (index.h(index.Host, null, this.resultInfo(), index.h("table", { class: "table stacktable border-bottom" }, index.h("thead", null, index.h("tr", null, index.h("th", { class: "person" }, "Person"), index.h("th", { class: "content" }, "Inhalt"), index.h("th", { class: "type" }, "Dokumententyp"), index.h("th", { class: "year" }, "Jahr"), index.h("th", { class: "author" }, "Autor"), index.h("th", { class: "details" }, "\u00A0"))), index.h("tbody", null, this.pagedResult().map(gardener => (index.h("tr", null, index.h("td", null, gardener.Person), index.h("td", null, gardener.Inhalt), index.h("td", null, gardener.Dokumententyp), index.h("td", null, gardener.Jahr), index.h("td", null, gardener.Autor), index.h("td", null, index.h("a", { class: "link", title: "Details", href: '#id' + gardener['ID'], onClick: () => this.recordSelectedHandler(gardener.ID) }, index.h("i", { class: "fa fa-info-circle fa-lg" })))))))), index.h("results-pagination", { "current-page": this.currentPage, pages: this.pages })));
    }
    static get watchers() { return {
...
const MyComponent = class {
    ...
    return_errors(errors) {
        return (index.h(index.Host, null, index.h("h5", null, "Fehler"), errors.map(error => (index.h("div", null, error)))));
    }
    render() {
        if (this.errors.length) {
            ...
            return (index.h(index.Host, null, index.h("loading-spinner", null)));
        }
        if (this.selectedRecord) {
            return (index.h(index.Host, null, index.h("filter-bar", { results: this.results }), index.h("gardener-detail", { record: this.selectedRecord })));
        }
        else {
            return (index.h(index.Host, null, index.h("filter-bar", { results: this.results }), index.h("gardener-results", { results: this.filteredResults })));
        }
    }
};
...
const Spinner = class {
    ...
    render() {
        return (index.h(index.Host, null, index.h("div", { class: "d-flex justify-content-lg-center py-3" }, index.h("i", { class: "fa fa-circle-o-notch fa-pulse fa-2x" }), index.h("span", { class: "px-3" }, "Loading..."))));
    }
};

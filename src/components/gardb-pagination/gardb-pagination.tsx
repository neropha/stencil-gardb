  ...
  pagination() {
    ...
    if (this.pages > 1) {
      ...
      if (this.currentPage > 1) {
        pages.push(
          <li class="page-item">
            <a class="page-link" onClick={() => this.changePage(this.currentPage - 1)}>
              &lsaquo;
            </a>
          </li>
        );
      ...
      for (let i = 1; i <= this.pages; i++) {
        ...
        // Default Page
          ...
          pages.push(
            <li class="page-item">
              <a class="page-link" onClick={() => this.changePage(i)}>
                {i}
              </a>
            </li>
          );
      ...
      pages.push(
        <li class="page-item">
          <a class="page-link" onClick={() => this.changePage(this.pages)}>
            &raquo;
          </a>
        </li>
      );
    ...
    return (
      <Host>
        <nav aria-label="Navigate results">
          <ul class="pagination justify-content-center">{this.pagination()}</ul>
        </nav>
      </Host>
    );
  }
